...
echo "src/gz sft1200_buddha https://cdn.jsdelivr.net/gh/Skyscrapers-xzx/SSR@MYSSR" >>/etc/opkg/customfeeds.conf
opkg update
action="$1"
case "${action}" in
ssr-plus)
...
wget -O /tmp/libsodium.ipk https://cdn.jsdelivr.net/gh/Skyscrapers-xzx/SSR@MYSSR/libsodium_1.0.18-2021-09-17-64129657_mips_siflower.ipk
